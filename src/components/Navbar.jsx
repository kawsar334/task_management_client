...
const Navbar = () => {
  ...
  return (
    <nav className="bg-gray-800 text-white py-3 md:py-1 px-4 flex justify-between items-center sticky top-0 left-0 ">
      <Link to="/"  className="text-2xl font-bold">Task</Link>

   { menu &&<div className='relative md:static w-[100%] md:w-max'>
        <div className="flex   md:items-center gap-4 flex-col md:flex-row absolute md:static w-full left-[-0px] top-[50px] bg-gray-800  p-4  ">
          {user ? (
            <>
   ...
   <span className='cursor-pointer md:hidden ' onClick={()=>setMenu(!menu)}>
    menu
   </span>
